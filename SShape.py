...
serv.setSpeedsvw(totalSpeed, angVel1)

distanceWheel1 = 0
speedTuple = enc.getSpeeds()
distanceWheel1 += (speedTuple[0] * 2.61 * math.pi)*(seconds/2) 
# revolutions per second times inches per revolution (inches per sec) times half of the total time (inches)
...
serv.setSpeedsvw(totalSpeed, angVel2)

distanceWheel2 = 0
speedTuple = enc.getSpeeds()
distanceWheel2 += (speedTuple[1] * 2.61 * math.pi)*(seconds/2) 
# revolutions per second times inches per revolution (inches per sec) times half of the total time (inches)
